...
import com.mivas.samplemvvm.adapter.NoteAdapter
import com.mivas.samplemvvm.viewmodel.NoteViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter.setOnItemClickListener(object : NoteAdapter.OnItemClickListener {
            override fun onItemClick(note: Note) {
                val intent = Intent(baseContext, AddEditNoteActivity::class.java).apply {
